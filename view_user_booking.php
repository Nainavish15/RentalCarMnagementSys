...
<html lang="en">
  ...
  <?php require_once("./layoyt/navbar.php");
   ...
   require_once("./action/db_conn.php");
        $user_id_log = $_SESSION['user_id_log'];
        //echo  $user_id_log ;
        $fetch_all_booking="SELECT * FROM user_table LEFT JOIN booking_master ON user_table.user_id = booking_master.user_id WHERE user_table.user_id='$user_id_log'";
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>View Bookings<i class="ion-ios-arrow-forward"></i></span></p>
            <h1 class="mb-3 bread">Your Booking Details</h1>
          </div>
        </div>
      </div>
      <!-------------------------------------------View Booking Modal------------------------------------------------->
  ...
  <?php require_once("./layoyt/footerlinks.php");?>
   ...
   <script>
    $(document).on("click",".viewBookingInfo",function(){
      ...
      $("#myModal").modal('show');
      $.ajax({
   url:"./Action/user_booking_view_details.php",
   type:"POST",
   data:{bid:booking_id  },
